            ...
            <div class="card-body">
                <form action="javascript:void(0)" method="post">
                    <div class="row">
                        ...
                        <div class="form-group col-sm-2">
                            <label for="course_status" class="col-sm-12">Course Status</label>
                            <div class="col-sm-12">
                            <select class="form-control placeholder-single" name="course_status" id="course_status"
                                    data-placeholder="<?php echo display('select_one'); ?>">
                                    <option value=""></option>
                        ...
                        <div class="form-group col-sm-1">
                            ...
                            <div class="col-sm-12">
                                <button type="button" class="btn btn-success text-white" id="coursefilter" onclick=""><i
            ...
            <div class="card-header">
                <h4>
                    ...
                    <small class="float-right">
                        <button type="button" class="btn btn-success text-white" data-toggle="collapse"
  ...
  <div class="modal fade" id="preview_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body previewdetails"></div>
            </div>
        </div>
    </div>

<input type="hidden" id="total_course" value="<?php echo (!empty($total_course) ? $total_course : 0); ?>">
