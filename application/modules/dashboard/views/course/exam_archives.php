        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="result_load">
                    <table class="table display table-bordered table-striped table-hover bg-white m-0" id="archivelist">
                        <thead>
                            <tr>
...
<input type="hidden" id="total_archive" value="<?php echo $total_archive; ?>">
