    ...
    <div class="col-sm-12 col-md-12">
        <div class="card">
            <div class="card-header">
                <h6><?php echo display('collaborate'); ?> With</h6>
            </div>
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <!-- <input name="logo" type="file" class="form-control" id="logo"
                                onchange="fileValueOne(this,'compnay')" value=""> -->
                            <input type="file" name="logo" id="logo" class="custom-input-file"
                                onchange="fileValueOne(this,'compnay')" />
                            <label for="logo">
                                <i class="fa fa-upload"></i>
                                <span class="logo-filename"><?php echo display('choose_file'). '...'; ?></span>
                            </label>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <img id="image-preview-compnay" src="" alt="" class="border border-2" width="200px">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="offset-3 mb-3">
                            <button type="button" class="btn btn-info w-md m-b-5 m-l-10"
                                onclick="company_infosave()"><?php echo display('save') ?></button>
                        </div>
                    </div>
                </form>
                <!-- language -->

                <table class="table table-bordered table-sm" id="companydatalist">
                    <thead>
                        <tr>
...
<!-- The Modal -->
<div class="modal fade" id="modal_infos" role="dialog">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title modal_ttls"></h5>
...
<input type="hidden" id="total_company" value="<?php echo html_escape($total_company); ?>">
