                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input name="redirect_url" class="form-control" type="text" id="redirect_url"
                            value="<?php echo base_url(enterpriseinfo()->shortname.'/signin'); ?>" readonly>
                    </div>
                    <div class="offset-4 col-sm-12">
                        <span class="text-danger">Please, copy the url and paste your google
                            developer console
                            <a href="https://console.cloud.google.com/" class="btn btn-success btn-sm"
                                targe="_new">Go</a>
                        </span>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <button type="button" class="btn btn-success w-md m-b-5"
                            onclick="googleconfigupdate('<?php echo (!empty($get_socialauthconfigdata->id) ? $get_socialauthconfigdata->id : ''); ?>')"><?php echo display('update') ?></button>
                    </div>
...
<script>
function googleconfigupdate(id) {
    ...
    $.ajax({
        url: base_url + enterprise_shortname + "/google-config-update",
        type: "POST",
        data: {
