        ...
        <div class="card">
            <div class="card-header">
                <h4><?php echo html_escape((!empty($title) ? $title : null)) ?>
                    ...
                    <!-- <a href="<?php echo base_url(enterpriseinfo()->shortname . '/notice-board-list'); ?>"
                            class="btn btn-success">
                            <?php echo display('notice_board_list'); ?>
                        </a> -->
                    </small>
                </h4>
            </div>
            <div class="card-body">
                ...
                <div class="form-group row">
                    <label for="sendto" class="col-sm-3 col-form-label">Individual/All<i class="text-danger">
                            *</i></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group row">
                    <div class="offset-4 mb-3">
                        <button type="submit" class="btn btn-info w-md m-b-5"><?php echo display('send') ?></button>
                    </div>
                </div>
                <?php echo form_close() ?>
            </div>
