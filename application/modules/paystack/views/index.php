<link rel="stylesheet" type="text/css" href="<?php echo base_url('application/modules/paystack/assets/css/bootstrap-toggle.css') ?>">
<script src="<?php echo base_url('application/modules/paystack/assets/js/bootstrap-toggle.min.js') ?>" type="text/javascript"></script>
<div class="row">
    <div class="col-sm-12">
        <?php
...
<div class="row">
    <div class="col-sm-12 col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo base_url('paystack/paystack/config_save'); ?>" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <select name="currency" class="form-control placeholder-single" id="currency">
                                ...
                                <option value="NGN" <?php if(@$get_configdata->currency == 'NGN'){ echo 'selected'; } ?>>(NGN) Nigeria</option>
