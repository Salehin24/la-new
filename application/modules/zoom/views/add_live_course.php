...
<div class="row">
    <div class="col-sm-12 col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <?php echo form_open_multipart(enterpriseinfo()->shortname .'/live-course-save', 'class="myform" id="myform"'); ?>
                <div class="row">
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input name="meeting_id" class="form-control" type="text" placeholder="<?php echo display('meeting_id') ?>" id="meeting_id" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group col-sm-6">
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input name="meeting_password" class="form-control" type="text" placeholder="<?php echo display('meeting_password') ?>"  id="meeting_password" required>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-sm-6">
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input name="start_date" class="form-control datepicker" type="text" placeholder="" id="start_date" placeholder="YYYY-MM-DD">
                            </div>
                        </div>
                    </div>
                    <div class="form-group col-sm-6">
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input name="end_date" class="form-control datepicker" type="text" placeholder="" id="end_date" placeholder="YYYY-MM-DD">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-sm-6">
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input name="start_time" class="form-control time_picker" type="text" placeholder="<?php echo display('start_time') ?>" id="start_time">
                            </div>
                        </div>
                    </div>
                    <div class="form-group col-sm-6">
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input name="end_time" class="form-control time_picker" type="text" placeholder="<?php echo display('end_time') ?>" id="end_time">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group offset-3 col-sm-2">
                    <button type="submit" class="btn btn-info w-md m-b-5" onclick=""  tabindex=""><?php echo display('save'); ?></button>
                </div>
                <?php echo form_close(); ?>
            </div>
        </div>
