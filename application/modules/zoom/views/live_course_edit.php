            ...
            <div class="card-header">
                <h5>
                    ...
                    <small class="float-right">
                        <a href="<?php echo base_url(enterpriseinfo()->shortname .'/live-course-list'); ?>" class="btn btn-success-soft">
                            <?php echo display('live') . ' ' . display('course_list'); ?>
                        </a>
                    </small>
                </h5>
            </div>
            <div class="card-body">
                <?php echo form_open_multipart(enterpriseinfo()->shortname .'/live-course-update', 'class="myform" id="myform"'); ?>
                <div class="row">
                    <div class="form-group col-sm-6">
                        <div class="row">
                            <label for="name" class="col-sm-3"><?php echo display('live') . ' ' . display('course_name') ?><i class="text-danger"> *</i></label>
                            <div class="col-sm-9">
                                <input name="name" class="form-control" type="text" placeholder="<?php echo display('name') ?>" id="name" value="<?php echo (!empty($get_livecourseeditdata->name) ? $get_livecourseeditdata->name : ''); ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <?php } else { ?>
                        <input type="hidden" class="faculty_id" name="faculty_id" value="<?php echo html_escape($get_livecourseeditdata->faculty_id); ?>">
                    <?php } ?>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        <div class="row">
                            <label for="meeting_id" class="col-sm-3"><?php echo display('meeting_id') ?> <i class="text-danger"> *</i></label>
                            <div class="col-sm-9">
                    ...
                    <div class="form-group col-sm-6">
                        <div class="row">
                            <label for="meeting_password" class="col-sm-3"><?php echo display('meeting_password') ?> </label>
                            <div class="col-sm-9">
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        <div class="row">
                            <label for="start_date" class="col-sm-3"><?php echo display('start_date') ?> <i class="text-danger"> *</i></label>
                            <div class="col-sm-9">
                                <input name="start_date" class="form-control datepicker" type="text" placeholder="" id="start_date" placeholder="YYYY-MM-DD" value="<?php echo (!empty($get_meetinginfo->start_date) ? $get_meetinginfo->end_date : ''); ?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group col-sm-6">
                        <div class="row">
                            <label for="end_date" class="col-sm-3"><?php echo display('end_date') ?> <i class="text-danger"> *</i></label>
                            <div class="col-sm-9">
                                <input name="end_date" class="form-control datepicker" type="text" placeholder="" id="end_date" placeholder="YYYY-MM-DD" value="<?php echo (!empty($get_meetinginfo->end_date) ? $get_meetinginfo->end_date : ''); ?>">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-sm-6">
                        <div class="row">
                            <label for="start_time" class="col-sm-3"><?php echo display('start_time') ?> <i class="text-danger"> *</i></label>
                            <div class="col-sm-9">
                    ...
                    <div class="form-group col-sm-6">
                        <div class="row">
                            <label for="end_time" class="col-sm-3"><?php echo display('end_time') ?> <i class="text-danger"> *</i></label>
                            <div class="col-sm-9">
                            ...
                            <div class="col-sm-9">
                                <select  name="category_id" class="form-control placeholder-single" id="category_id" data-placeholder="<?php echo display('select_one'); ?>" required>
                                    ...
                                    <?php foreach ($get_category as $category) { ?>
                                        <option value="<?php echo html_escape($category->category_id); ?>" <?php echo ($category->category_id == $get_livecourseeditdata->category_id) ? 'selected' : ''; ?>>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <select  name="course_level" class="form-control placeholder-single" id="course_level" data-placeholder="<?php echo display('select_one'); ?>">
                                    <option value=""></option>
                                    <option value="1" <?php echo ($get_livecourseeditdata->course_level == 1) ? 'selected' : ''; ?>>Beginner</option>
                                    <option value="2" <?php echo ($get_livecourseeditdata->course_level == 2) ? 'selected' : ''; ?>>Intermediate</option>
                                    <option value="3" <?php echo ($get_livecourseeditdata->course_level == 3) ? 'selected' : ''; ?>>Advanced</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-sm-6">
                        <div class="row">
                            ...
                            <?php if ($get_livecourseeditdata->picture) { ?>
                                <div class="img_border col-sm-2">
                                    <img src="<?php echo base_url(html_escape($get_livecourseeditdata->picture)); ?>" alt="<?php echo html_escape($get_livecourseeditdata->name); ?>" width="100%">
                                </div>
                            <?php } ?>
                        </div>
                    </div>
                    <div class="form-group col-sm-6">
                        <div class="form-group row m-r">
                            <div class="offset-3 checkbox checkbox-success">
                                <input id="is_free" name="is_free" type="checkbox" value="0" <?php
                ...
                <div class="row dependent_freecourse">
                    <?php if ($get_livecourseeditdata->is_free == 0) { ?>
                        <div class="form-group col-sm-6">
                            <div class="row">
                                <label for="price" class="col-sm-3"><?php echo display('current') . " " . display('price'); ?> </label>
                                <div class="col-sm-9">
                                    <input name="price" class="form-control" type="number" placeholder="<?php echo display('price') ?>" id="price" onkeyup="onlynumber_allow(this.value, 'price')" value="<?php echo (!empty($get_livecourseeditdata->price) ? $get_livecourseeditdata->price : ''); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="form-group col-sm-6">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input name="oldprice" class="form-control" type="number" placeholder="<?php echo display('oldprice') ?>" id="oldprice" onkeyup="onlynumber_allow(this.value, 'oldprice')" value="<?php echo (!empty($get_livecourseeditdata->oldprice) ? $get_livecourseeditdata->oldprice : ''); ?>">
                                </div>
                            </div>
                        </div>
                    <?php } ?>
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <textarea name="description" id="description" rows="10" cols="80"><?php echo (!empty($get_livecourseeditdata->description) ? $get_livecourseeditdata->description : ''); ?></textarea>   
                            </div>
                        </div>
                    </div>
                    <div class="form-group col-sm-6">
                            ...
                            <?php if ($user_type == 1) { ?>
                                <div class="form-group row m-r">
                                    <div class="checkbox checkbox-success">
                                        <input id="is_popular" type="checkbox" name="is_popular" value="<?php echo $get_livecourseeditdata->is_popular; ?>" <?php
                ...
                <input type="hidden" name="course_id" id="course_id" value="<?php echo $get_livecourseeditdata->course_id; ?>">
