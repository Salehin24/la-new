            ...
            <div class="col-md-12">
                <div class="card border-0 rounded-0 shadow-sm">
                    <div class="card-body p-4 p-xl-5">
                        <div class="d-block d-sm-flex">
                            ...
                            <div class="ms-sm-4 mt-4 mt-sm-0 pb-4">
                                ...
                                <a class="subtitle-one" href="<?php echo base_url($enterprise_shortname.'/student-profile-show/'.$get_studentinfo->student_id); ?>">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <i class="fas fa-thumbs-up me-1"></i>
                                            <div class="d-block">
                                                <div><?php echo (!empty($projectlikecount) ? $projectlikecount : '0'); ?></div>
                                            </div>
                                        </div>
                                        <div class="align-items-center d-flex font-open fs-13 fw-bold me-3 iconicText">
                                            <i class="far fa-comment me-1"></i>
                                            <div class="d-block">
                                                <div><?php echo (!empty($projectcommentcount) ? $projectcommentcount : '0'); ?></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card-body p-4 p-xl-5 bg_blue_pro">
                        <div class="row">
                            <div class="col-md-8 d-block d-lg-flex">
                                <div class="img-part rounded">
                                ...
                                <div class="mt-4 mt-lg-0 ms-lg-4 pb-4">
                                    ...
                                    <div class="subtitle-two my-3">By -
                                        <a class="subtitle-one" href="<?php echo base_url($enterprise_shortname.'/instructor-profile-show/'.$get_projectsingledata->faculty_id); ?>">
                            ...
                            <!--End Section Header-->
                            <?php //d($get_projectsingledata);
                            if($get_projectsingledata->coursetype != 2){
                            ?>
                            <div class="d-flex">
                                <div class="mb-3 me-2">
                            ...
                            <div class="mb-3">
                                <div class="">
                                    ...
                                    <label class="form-check-label" for="review">
                                        ...
                                        <span class="check-info p-2 rounded d-inline-block mb-2">
                                            <span>This course project is being being reviewed </span>
                                        </span>
                                    </label>
                                </div>
                            </div>
                            <div class="mb-3">
                                <div class="">
                                    ...
                                    <label class="form-check-label" for="approved">
                                        ...
                                        <span class="check-success p-2 rounded d-inline-block mb-2">
                                            <span>Congratulations!<br> This course project has been approved</span>
                                        </span>
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <div class="position-relative project_vdo">
                                    <img src="<?php echo youtube_thumbs($youtubeid); //base_url(!empty($get_projectsingledata->coverpic) ? $get_projectsingledata->coverpic : default_600_400()); ?>"
                                        style="width: 100%;">
                                    <div class="">
...
<input type="hidden" value="<?php echo $get_projectsingledata->user_id;?>" id="student_id">
                            ...
                            <div class="border-0 card">
                                ...
                                <div class="likeunlike-area">
                                    ...
                                    <button class="btn btn-danger w-75"
                                        onclick="likeunlikethisproject('<?php echo $get_projectsingledata->project_id?>', 0)"><i class="fas fa-thumbs-down me-2"></i>I Unlike this project</button>
                                    <?php }else{ ?>
                                    <button class="btn btn-dark-cerulean w-75"
                                        onclick="likeunlikethisproject('<?php echo $get_projectsingledata->project_id?>', 1)"><i class="fas fa-thumbs-up me-2"></i>I like this project</button>
                                    <?php } ?>
                                </div>
