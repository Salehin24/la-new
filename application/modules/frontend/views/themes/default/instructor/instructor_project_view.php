...
<div class="bg-alice-blue py-5">
    <div class="container-xxl custom-content">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="<?php echo base_url($enterprise_shortname .'/instructor-project-add'); ?>" class="btn btn-transparent border py-2">
                Add New Project
            </a>
        </div>
    </div>
                        ...
                        <div class="d-block d-sm-flex">
                            ...
                            <div class="ms-sm-4 mt-4 mt-sm-0 pb-4">
                                ...
                                <div class="subtitle-one my-3">By -
                                     <a href="<?php echo base_url($enterprise_shortname.'/instructor-profile-show/'.$get_instructorinfo->faculty_id); ?>">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="align-items-center d-flex font-open fs-13 fw-bold me-3 iconicText">
                                            ...
                                            <div class="d-block">
                                                <div><?php echo $projectlikecount; ?></div>
                                            </div>
                                        </div>
                                        <div class="align-items-center d-flex font-open fs-13 fw-bold me-3 iconicText">
                                            <i class="far fa-comment me-1"></i>
                                            <div class="d-block">
                                                <div><?php echo $projectcommentcount; ?></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-4">
                                    ...
                                    <h6 class="font-open fs-15 fw-bold lh-20 mb-1 text-black">
                                        <!-- <a href="<?php echo base_url($enterprise_shortname.'/student-profile-show/'.$get_studentinfo->student_id); ?>"> -->
                                        <?php echo (!empty($get_instructorinfo->name) ? $get_instructorinfo->name : ''); ?>
                                        <!-- </a> -->
                                    </h6>
                                    <p class="mb-0">
                            ...
                            <div class="col-md-8 d-block d-lg-flex">
                                ...
                                <div class="mt-4 mt-lg-0 ms-lg-4 pb-4">
                                    ...
                                    <div class="subtitle-two my-3">By -
                                        <?php echo html_escape($get_projectsingledata->instructor_name); ?></div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <div class="d-block d-md-flex align-items-center">
                                        <?php
                                            if($get_projectsingledata->project_status != 4){ ?>
