...
<?php if($instructor_info->is_resumeshow == 1){
    ...
    <div class="container-lg">
        <div class="card border-0 rounded-0 shadow-sm">
            <div class="card-body p-4 p-xl-5 d-flex justify-content-between align-items-center">
                <h4 class="mb-0">Resume/Portfolio PDF </h4>
    ...
    <div class="container-lg">
        ...
        <div class="card border-0 rounded-0 shadow-sm">
            <div class="card-body p-4 p-xl-5">
                <div class="mb-3">
                    <h4 class="mb-1"><?php echo (!empty($instructor_info->name) ? $instructor_info->name : ''); ?></h4>
                </div>
                <?php 
...
<div class="bg-alice-blue py-3">
    <div class="container-lg">
        <?php 
             $skilss = ($instructor_info->skills ? explode(',', $instructor_info->skills) : '');
             if($skilss){
             ?>
        <div class="card border-0 rounded-0 shadow-sm">
            <div class="card-body p-4 p-xl-5">
...
<?php  if($instructor_info->is_proficiencyshow == 1){ ?>
<div class="bg-alice-blue py-3">
    <div class="container-lg">
        <?php
            if($instructor_profi){ ?>
                    ...
                    <ul class="nav nav-pills mb-3 assignment_nav-pills" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="pills-one-tab" data-bs-toggle="pill"
                                ...
                                aria-selected="true" onclick="typewiseprojectpublic('0', 'view')">All</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link featured_work_color fw-semi-bold" id="pills-two-tab"
                                ...
                                onclick="typewiseprojectpublic('1', 'view')">Course Project</button>
                        </li>
                        <li class="nav-item" role="presentation">
                        ...
                        <!-- <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-four-tab" data-bs-toggle="pill"
                                ...
                                aria-selected="false" onclick="typewiseprojectpublic('3', 'view')">Practice
                                Project</button>
                        </li> -->
                    </ul>
...
<div class="bg-alice-blue py-3">
    <div class="container-lg">
        <?php
            if($instructor_info->contact_text || $instructor_info->public_email){
            ?>
        <div class="card border-0 rounded-0 shadow-sm">
            <div class="card-body p-4 p-xl-5">
                <!--Start Section Header-->
                ...
                <div class="text-center">
                    ...
                    <h6 class="text-navy-blue"><?php echo $instructor_info->contact_text; ?>? <span
                            class="text-danger">Say hello At</span></h6>
                    <?php } ?>
                    <a href="mailto:webmaster@example.com"
                        class="fs-3"><?php echo $instructor_info->public_email; ?></a>
...
function typewiseprojectpublic(type, mode) {
    ...
    var enterprise_id = $("#enterprise_id").val();
    var instructor_id = $("#segment3").val();
    var CSRF_TOKEN = $("#CSRF_TOKEN").val();

    $.ajax({
        url: base_url + enterprise_shortname + "/type-wise-instructor-project-public",
        type: "POST",
        data: {
