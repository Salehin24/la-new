...
<div class="bg-alice-blue py-3">
    <div class="container-lg custom-content">
        <?php echo form_open_multipart($enterprise_shortname .'/instructor-project-submitupdate', 'class="row g-3" id="myform"'); ?>
        <div class="row">
            <div class="col-md-12">
                            ...
                            <div class="col-lg-8 ps-xl-5">
                                <div class="mt-4 mt-lg-0 pro_add_form">
                                    ...
                                    <div class="mb-3">
                                        <div class="d-flex align-items-center">
                                            <select class="input-box px-2 courseTypeselect"
                                                aria-label="Default select example" id="CourseType" name="coursetype" onchange="projecttypechange(this.value)">
