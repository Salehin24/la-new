                ...
                <div class="row">
                    <div class="col-md-3 pe-xl-5 d-none d-md-block sticky-content">
                        ...
                        <div class="sidebar-filter">
                            <h4 class="fw-bold text-dark-cerulean mb-4"><a href="<?php echo base_url($enterprise_shortname. '/allcourse/'); ?>" class="text-dark-cerulean">All Categories</a></h4>
                            ...
                            //  foreach($get_popularcourse as $category_course){?>
                            ...
                            ?>
                              <?php 
                                if($parent->category_id==$this->uri->segment(3)){ 
                                    $check="checked";
                                }else{
                                    $check="";
                                }
                            ?>
                            <h6 class="fw-semi-bold text-dark-cerulean mt-3 cat_radio"><a style="color: #07477D;" href="<?php echo base_url($enterprise_shortname . '/category-course/' . html_escape($parent->category_id)); ?>"><input type="radio" name="" <?php echo $check;?>><label class="ms-2"><?php echo html_escape($parent->name); ?></label></a></h6>
                            ...
                            <?php
                                ...
                                <li><a href="#"><?php //echo html_escape($childcategory->name); ?></a></li>
                                
                                <?php }else{?>
                                    <?php if($subcategory->category_id==$this->uri->segment(3)){ 
                                        $check="checked";
                                        }else{
                                        $check="";
                                        }
                                    ?>
                                    <li><a href="<?php echo base_url($enterprise_shortname . '/category-course/' . html_escape($subcategory->category_id)); ?>"><input type="radio" name="" <?php echo $check;?>><label class="ms-2"><?php echo html_escape($subcategory->name); ?></label></a></li>
                                <?php }} ?>
                                <hr class="my-2 bg-dark-cerulean">
                            </ul>
                            
                            <?php  }else{?>
                                <!-- <ul class="list-unstyled cat-list my-2"> -->
                                <!-- <li> -->
                                <?php 
                                    if($parent->category_id==$this->uri->segment(3)){ 
                                        $check="checked";
                                ...
                                ?>
                                <h6 class="fw-bold text-dark-cerulean cat_radio"><a style="color: #07477D;" href="<?php echo base_url($enterprise_shortname . '/category-course/' . html_escape($parent->category_id)); ?>"><input type="radio" name="" <?php echo $check;?>><label class="ms-2"><?php echo html_escape($parent->name); ?></label></a></h6>
                                <!-- <hr class="my-2 bg-dark-cerulean"> -->
                                <!-- </li> -->
                                <hr class="my-2 bg-dark-cerulean">  
                            <!-- </ul> -->
                    ...
                    <div class="col-md-9 sticky-content">
                        ...
                        $category_image=$this->db->select('a.category_id,a.name category_name,b.picture')
                                ->from('category_tbl a')
                                ->join('picture_tbl b', 'b.from_id = a.category_id', 'left')
                                ->where('category_id',$category_image_id)
                        ...
                        <div class="category-banner bg-img text-white p-4 p-sm-5 mb-4" data-image-src="<?php echo base_url(!empty($category_image->picture) ? "$category_image->picture" : 'application/modules/frontend/views/themes/' . html_escape(get_activethemes()->name) .'/assets/img/category-banner-bg.jpg'); ?>">
                            <h2 class="fw-semi-bold">All Categories<?php //echo html_escape($category_info->name); ?></h2>
                            <p>Find what fascinates you as you explore these classes.</p>
                        ...
                        <div class="row justify-content-center gx-3 gy-4">
                            ...
                            foreach($category_courses as $category_course){
                                   $categoryinfo= $this->db->select('*')->from('category_tbl')->where('category_id', $category_course->category_id)->get()->row();
                             ?>
                                        ...
                                        <div class="position-relative overflow-hidden bg-prussian-blue">
                                            ...
                                            <!--Start items badge-->
                                                <div class="align-items-center top-0 d-flex fs-12 position-absolute px-3 py-2 start-0 text-white w-100 z-index-2">
                                                    ...
                                                    <?php }?>
                                                    <span class="badge-business"><?php echo html_escape($categoryinfo->name);?></span>
                                            ...
                                            if(!empty($category_course->is_discount==1)){ ?>
                                            ...
                                            <div class="course-card__hover--content">
                                                ...
                                                <h3 class="bottom-0 course-card__hover--content___text d-block fs-15 mb-0 position-absolute text-capitalize text-decoration-none text-white">
                                                    <a href="<?php echo base_url($enterprise_shortname. '/course-details/'. $category_course->course_id); ?>"
                                                        class="text-decoration-none text-white"><?php echo (!empty($category_course->name) ? $category_course->name : ''); ?></a>
                                                </h3>
                                            </div>
                                            ...
                                            <div class="d-block">
                                                ...
                                                <div class="align-items-center d-flex form-check ps-0">
                                                    ...
                                                    <input class="me-1" style="width:21px;height:21px" type="radio"
                                                        ...
                                                        onclick="subscriptionchecedRadio('<?php echo $category_course->course_id;?>')" <?php //echo (!empty($param == 1) ? 'checked' : ''); ?>>
                                                ...
                                                <div class="form-check d-flex align-items-center ps-0">
                                                    <input class="me-1" style="width:21px;height:21px" type="radio"
                                                        ...
                                                        <?php echo 'checked'; //echo (!empty($param == 1) ? '' : 'checked'); ?>>
                                                    <label
                            ...
                            <div class="text-center mt-5">
                                <div id="load<?php echo  $category_course->id ;?>">
                                    <button type="button"  onClick="all_course_load('<?php echo $category_course->id ;?>')" class="btn btn-lg btn-dark-cerulean load" id="<?php echo  $category_course->id ;?>">
                                        Browse more Courses
