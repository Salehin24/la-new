        ...
        <div class="course-card course-card-shadow rounded-6 bg-white position-relative overflow-hidden">
            <div class="position-relative overflow-hidden bg-prussian-blue">
                ...
                <a href="<?php echo base_url($enterprise_shortname. '/course-details/'. $category_course->course_id); ?>"
                    ...
                    <img src="<?php echo base_url(!empty($category_course->picture) ? $category_course->picture : default_600_400()); ?>"
                ...
                <span class="px-0 badge m-3   position-absolute start-0 text-white   z-index-2 polygon-shape"
                    style="top:25px">
                    <span class="d-block fs-13 mb-1">Off</span>
                    <span
                        class="fs-15 fw-bold"><?php  echo (($category_course->discount) ? $category_course->discount :''); ?><?php if($category_course->discount_type==2){ echo "%";}else{ echo " ";}?></span>
                </span>
                <?php }?>
                <!--End items badge-->
                <!--End Course Image-->
                ...
                <div class="course-card__hover--content">
                    ...
                    <a class="course-card__hover--content___icon popup-youtube"
                        href="<?php echo (!empty($category_course->url)? $category_course->url : ''); ?>" autoplay>
            ...
            // check purchase or subscription 
                ...
                <div class="d-block">
                    ...
                    <input type="hidden" class="course" value="<?php echo $category_course->course_id;?>"
                    ...
                    <div class="form-check d-flex align-items-center ps-0">
                        <input class="me-1" style="width:21px;height:21px" type="radio"
                            ...
                            onclick="coursechecedRadio('<?php echo $category_course->course_id;?>')" checked>
                        <label class="align-items-center d-flex form-check-label fw-bold justify-content-between"
                            style="width:100%;" for="flexRadioDefault2_<?php echo $category_course->course_id?>">
                            <span class="course_price_cart">Course Price
                                <span class="text-success">
                                </span>
                            </span>
                    ...
                    <div class="align-items-center d-flex form-check ps-0">
                        <input class="me-1" style="width:21px;height:21px" type="radio"
                            name="flexRadioDefault1_<?php echo $category_course->course_id?>"
                            id="flexRadioDefault1_<?php echo $category_course->course_id?>"
                            onclick="subscriptionchecedRadio('<?php echo $category_course->course_id;?>')" disabled>
                    ...
                    <div class="align-items-center d-flex form-check ps-0">
                        <input class="me-1" style="width:21px;height:21px" type="radio"
                            name="flexRadioDefault1_<?php echo $category_course->course_id?>"
                            id="flexRadioDefault1_<?php echo $category_course->course_id?>"
                            onclick="subscriptionchecedRadio('<?php echo $category_course->course_id;?>')" checked>
                        <label class="form-check-label fw-bold course_price_cart"
                            for="flexRadioDefault1_<?php echo $category_course->course_id?>">
                            Subscription
                        </label>
                    ...
                    <div class="form-check d-flex align-items-center ps-0 ">
                        <input class="me-1" style="width:21px;height:21px" type="radio"
                            name="flexRadioDefault2_<?php echo $category_course->course_id?>"
                            id="flexRadioDefault2_<?php echo $category_course->course_id?>"
                            onclick="coursechecedRadio('<?php echo $category_course->course_id;?>')" disabled>
                        <label
...
<div class="text-center mt-5">
    <div id="load<?php echo  $category_course->id ;?>">
        <button type="button" onClick="all_course_load('<?php echo $category_course->id ;?>')"
            class="btn btn-lg btn-dark-cerulean load" id="<?php echo  $category_course->id ;?>">
            Browse more Courses
