            ...
            <div class="col-xl-9">
                <div class="border-md mx-0 rounded-3 row">
                    <div class="border-end-md col-md-6 p-sm-5 px-5">
                        <h2 class="h3 mb-4 fw-bold text-uppercase align-items-center" style="text-align:center">Join Lead Academy</h2>
                        <h4 class="mb-0" style="font-size:20px ;text-align:center">Get Unlimited Access To World Class Online Learning</h4>
                        <br>
                        <center class="text-center">
                        <a href="<?php echo base_url($enterprise_shortname.'/ins-signup'); ?>"><strong>Become an Instructor</strong></a> 
                        </center>
                        <img class="d-block img-fluid mx-auto" style="margin-top:100px" src="<?php echo base_url('application/modules/frontend/views/themes/' . html_escape(get_activethemes()->name) . '/assets/img/signup.svg'); ?>"
                    ...
                    <div class="col-md-6 px-4 pt-2 pb-4 px-sm-5 pb-sm-5 pt-md-5">
                        ...
                        <?php echo form_open_multipart('#', 'class="myform" id="student"'); ?>
                        <div class="mb-3">
                        ...
                        <div class="mb-3 position-relative">
                            <label class="form-label mb-1" for="password"><?php echo display('password'); ?>
                        ...
                        <div class="form-check mb-4">
                            ...
                            <label class="form-check-label" for="agree-to-terms">By joining,  I read and agree to the <a
                                    ...
                                    class="text-decoration-underline">Terms & Conditions</a>,<a
                                    href="<?php echo base_url($enterprise_shortname. '/privacy-policy/'); ?>"
                                    target="_blank" class="text-decoration-underline">Privacy policy</a>,
                        ...
                        <button class="btn btn-dark-cerulean btn-lg w-100 registerbtn" onclick="register_save(4)"
                            type="button">Sign up</button>
                        <?php echo form_close(); ?>
                        <div class="mt-sm-4 text-center">Already have an account?
                            <strong>
                                <a href="<?php echo base_url($enterprise_shortname . '/signin'); ?>"
                                    class="text-decoration-underline"><?php echo display('sign_in'); ?></a>
                            </strong>
                        </div>
                    </div>
                </div>
