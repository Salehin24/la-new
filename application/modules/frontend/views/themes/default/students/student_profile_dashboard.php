                ...
                <div class="row text-center">
                        ...
                        <div class="zone upload text-center">
                            <div id="dropZ">
                                <div class="selectFile">
                                    <label for="profilepic"><i data-feather="camera" class="me-2"></i>Upload Profile
                                        Picture</label>
                                    <input type="file" name="profilepic" id="profilepic"
                                        onchange="studentprofilepictureupload(this)">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="zone upload text-center">
                            <div id="dropZ2">
                                <div class="selectFile">
                                    <label for="coverpicture"><i data-feather="image" class="me-2"></i>Upload Cover
                                        Picture</label>
                    ...
                    <div class="col-md-3">
                        <div class="zone upload text-center " >
                            <a href="<?php echo base_url($enterprise_shortname .'/student-profile-edit'); ?>" style="min-width: 260px;line-height: 24px;"
                                class="btn btn-lg btn-dark-cerulean mb-2"> <i data-feather="edit-3" class="me-2"></i>Edit
                                Profile</a>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="zone upload text-center " >
                            <a href="<?php echo base_url($enterprise_shortname. '/student-profile-show/'.$user_id); ?>" style="min-width: 260px;line-height: 24px;"
                                class="btn btn-lg btn-dark-cerulean mb-2 text-white"> <i data-feather="eye" class="me-2"></i>Public View</a>
                        </div>
                    </div>                    
                </div>
            </div>
...
<!--Student Profile Edit Option-->
<!--Start About Myself-->
<?php //if($get_studentinfo->is_profileshow == 1){ ?>
<div class="bg-alice-blue py-3">
    <div class="container-lg">
...
<?php $resume = get_studentinfo(get_userid())->resume; ?>
<div class="bg-alice-blue py-3">
    <div class="container-lg">
        <?php if($resume){ 
            //if(get_studentinfo(get_userid())->is_resumeshow == 1){ ?>
        <div class="card border-0 rounded-0 shadow-sm">
...
<?php if($get_studentproficiency){ 
    // if($get_studentinfo->is_proficiencyshow == 1){ ?>
<div class="bg-alice-blue py-3">
    <div class="container-lg">
        <div class="card border-0 rounded-0 shadow-sm">
            <div class="card-body p-4 p-xl-5">
...
<!--Start Featured Work-->
<?php
//d($get_featuredprojectportfolio);
 if($get_featuredprojectportfolio){ ?>
<div class="bg-alice-blue py-3">
    <div class="container-lg">
        <div class="card border-0 rounded-0 shadow-sm">
            <div class="card-body p-4 p-xl-5">
                    ...
                    <ul class="nav nav-pills mb-3 assignment_nav-pills" id="pills-tab" role="tablist">
                        ...
                        <!-- <li class="nav-item" role="presentation">
                            <button class="featured_work_color fw-semi-bold nav-link" id="pills-four-tab"
                                ...
                                onclick="typewiseproject('3', 'view')">Practice Project</button>
                        </li> -->
                    </ul>
...
//if($get_studentinfo->is_experienceshow == 1){ ?>
<div class="bg-alice-blue py-3">
    <div class="container-lg">
        <div class="card border-0 rounded-0 shadow-sm">
            <div class="card-body p-4 p-xl-5">
...
//if($get_studentinfo->is_educationshow == 1){ ?>
<div class="bg-alice-blue py-3">
    <div class="container-lg">
        <div class="card border-0 rounded-0 shadow-sm">
            <div class="card-body p-4 p-xl-5">
...
//if($get_studentinfo->is_certificateshow == 1){ ?>
<div class="bg-alice-blue py-3">
    <div class="container-lg">
        <div class="card border-0 rounded-0 shadow-sm">
            <div class="card-body p-4 p-xl-5">
...
if($get_studentinfo->contacttitle || $get_studentinfo->public_email){
 //if($get_studentinfo->is_contactshow == 1){ ?>
<div class="bg-alice-blue py-3">
    <div class="container-lg">
        <div class="card border-0 rounded-0 shadow-sm">
            <div class="card-body p-4 p-xl-5">
                ...
                <div class="text-center">
                    ...
                    <h6 class=" fw-semi-bold text-navy-blue">
                        <?php echo (!empty($get_studentinfo->contacttitle) ? $get_studentinfo->contacttitle : ''); ?>
                    </h6>
                    <?php //} ?>
                    <a href="mailto:webmaster@example.com" class="fw-semi-bold"
                        style="color:#063f80;font-size:23px;"><?php echo (!empty($get_studentinfo->public_email) ? $get_studentinfo->public_email : ''); ?></a>
                    <?php 
                        $this->db->select('*');
