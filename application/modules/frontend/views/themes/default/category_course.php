            ...
            <div class="container-lg">
                ...
                <div class="row">
                    <div class="col-md-3 pe-xl-5 d-none d-md-block sticky-content">
                        ...
                        <h5 class="fw-bold text-dark-cerulean mb-4"><a href="<?php echo base_url($enterprise_shortname. '/allcourse/'); ?>" class="text-dark-cerulean">All Categories</a></h5>
                        ...
                        <!-- <h5 class="fw-bold text-dark-cerulean">Most Popular</h5>
                            ...
                            ?>
                            <?php if($parent->category_id==$this->uri->segment(3)){ 
                            ...
                            <?php  }else{?>
                                ...
                                ?>
                                <h6 class="fw-semi-bold text-dark-cerulean cat_radio"><a style="color: #07477D;" href="<?php echo base_url($enterprise_shortname . '/category-course/' . html_escape($parent->category_id)); ?>"><input type="radio" name="" <?php echo $check;?>><label class="ms-2"><?php echo html_escape($parent->name); ?></label></a></h6>
                                <!-- <hr class="my-2 bg-dark-cerulean"> -->
                                <!-- </li> -->
                                <hr class="my-2 bg-dark-cerulean">  
                            <!-- </ul> -->
                    ...
                    <div class="col-md-9 sticky-content">
                        ...
                        <div class="row justify-content-center gx-3 gy-4">
                            ...
                            <?php 
                        //   echo   count($category_courses)
                             if($categorycourse_count >6){ 
                            ?>
