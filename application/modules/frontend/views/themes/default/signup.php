                    ...
                    <div class="col-xl-9">
                        <div class="row mx-0 align-items-center border-md rounded-3">
                            ...
                            <div class="col-md-6 px-4 pt-2 pb-4 px-sm-5 pb-sm-5 pt-md-5">
                                ...
                                <form>
                                    <div class="mb-3">
                                        <label class="form-label mb-1" for="signup-name">Full name</label>
                                        <input class="form-control form-control-lg" type="text" id="signup-name" placeholder="Enter your full name" autofocus required="">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label mb-1" for="signup-email">Email address</label>
                                        <input class="form-control form-control-lg" type="email" id="signup-email" placeholder="Enter your email" required="">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label mb-1" for="signup-password">Password <small class="fs-sm text-muted"></small></label>
                                        <input class="form-control form-control-lg" type="password" id="signup-password" required="">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label mb-1" for="signup-password-confirm">Confirm password</label>
                                        <input class="form-control form-control-lg" type="password" id="signup-password-confirm" required="">
                                    </div>
                                    ...
                                    <button class="btn btn-dark-cerulean btn-lg w-100" type="submit">Sign up</button>
                                </form>
                            </div>
                        </div>
                    </div>
