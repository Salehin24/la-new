<link rel="stylesheet" type="text/css" href="<?php echo base_url('application/modules/sslcommerz/assets/css/bootstrap-toggle.css') ?>">
<script src="<?php echo base_url('application/modules/sslcommerz/assets/js/bootstrap-toggle.min.js') ?>" type="text/javascript"></script>
<div class="row">
    <div class="col-sm-12">
        <?php
...
<div class="row">
    <div class="col-sm-12 col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo base_url('sslcommerz/sslcommerz/config_save'); ?>" method="post">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="payment_method_name" class="form-control" id="payment_method_name" value="<?php echo @$get_configdata->payment_method_name; ?>" placeholder="<?php echo display('payment_method_name'); ?>" tabindex="1" required>
                        </div>
                    </div>
                    <div class="form-group row">
